        ...
        {certificate.map(({ title, desc, image, link, id }) => (
          ...
          >
            <CardContainer className="inter-var">
              <CardBody className=" relative group/card  dark:hover:shadow-2xl dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border  ">
                <CardItem
                  translateZ="50"
                ...
                <CardItem
                  as="p"
                  translateZ="60"
                  className="lg:text-base lg:font-normal font-light text-white-200 text-sm line-clamp-2 mt-1"
                >
                  {desc}
                </CardItem>
